...
export default function Arrow({ onclick, size, color, className }: SVGProps) {
  return (
<svg onClick={onclick} fill={color} width={size} height={size} className={className}  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
