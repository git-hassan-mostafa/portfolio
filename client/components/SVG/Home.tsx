...
export default function Home({ size, color, className }: SVGProps) {
  return (
<svg fill={color} width={size} height={size} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
