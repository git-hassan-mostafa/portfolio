    ...
    <aside className={className}>
      <section className={s.personal}>
        <ArrowLeft
          ...
          className={s["side-bar-arrow-left"]}
          size={"30"}
        ...
        <p className={s.speciality}>Software Engineer | .NET | React | SQL</p>
      </section>
      <section className={s.information}>
        ...
        <section className={s.languages}>
          <div className={s.language}>
            <ProgressCircule
              ...
              percentage={100}
              borderWidth={4}
              bottomCirculeColor={"#191923"}
              topCirculeColor={"#FFC107"}
              textColor={"#8c8c8e"}
              fontSize={12}
            />
        ...
        <section className={s["social-media"]}>
          ...
          <Link
            target="_blank"
            href={"https://www.linkedin.com/in/hassan-mostafa-119985239/"}
          >
            <Linkedin
              className={s["social-media-icon"]}
              size={"25"}
          ...
          <Link
            target="_blank"
            href={"https://www.facebook.com/ha.mo.1485537/"}
          >
            <Facebook
              className={s["social-media-icon"]}
              size={"25"}
          ...
          <Link
            target="_blank"
            type="mail"
            href={"mailto:mohamad.hm464@gmail.com"}
          >
            <Mail
              className={s["social-media-icon"]}
              size={"25"}
